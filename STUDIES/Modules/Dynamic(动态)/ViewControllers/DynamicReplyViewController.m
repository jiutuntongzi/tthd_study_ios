...
@interface DynamicReplyViewController ()<UICollectionViewDataSource,UICollectionViewDelegate, TZImagePickerControllerDelegate, UIImagePickerControllerDelegate, YYTextViewDelegate, QMUIKeyboardManagerDelegate, RequestManagerDelegate>
...
@implementation DynamicReplyViewController
#pragma mark - lazy
-(UIView *)toolsView
{
    if (!_toolsView) {
...
-(void)submit
{
    ...
    [self.requestManager postDynamicCommentWithToken:Token
                                            parentId:_parentId
                                           dynamicId:_dynamicId
                                             content:_tagString
                                       contentImages:imgUrls
                                         requestName:POST_DYNAMIC_COMMENT];
}
...
{
    if ([requestName isEqualToString:POST_DYNAMIC_COMMENT]) {
