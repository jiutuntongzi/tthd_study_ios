...
@implementation LineHotPlaceCell
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LineDestinationModel *model = _dataArray[indexPath.item];
    ...
    UILabel *label = [MyTools labelWithText:model.name textColor:UIColorWhite textFont:UIFontMake(18) textAlignment:NSTextAlignmentCenter];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.selectItemBlock) {
        self.selectItemBlock(model.dId);
    }
}
