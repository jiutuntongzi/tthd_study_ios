...
-(void)initLayout
{
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, Home_Line_Height) collectionViewLayout:layout];
...
{
    self.selectedLineBlock(_dataArray[indexPath.item]);
}
