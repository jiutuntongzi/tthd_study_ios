//
//  TeacherHomeContainerEvaluteView.h
//  STUDIES
//
...
@interface TeacherHomeContainerEvaluteView : UIView<JXPagerViewListViewDelegate, UITableViewDataSource, UITableViewDelegate, RequestManagerDelegate>
{
    int _offset;
